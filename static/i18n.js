...
const LOCALES = {
  en: {
    ...
    mcp_field_args: 'Arguments (one per line)',
    mcp_field_url: 'URL',
    ...
    // MCP management CRUD
    mcp_edit_server: 'Edit',
    mcp_delete_server: 'Delete',
    mcp_field_env: 'Environment Variables',
    mcp_manage_hint: 'Use Add/Edit/Delete to manage servers, then click Reload MCP to apply changes.',
    mcp_test_connection: 'Test Connection',
    mcp_testing: 'Testing connection...',
    mcp_test_success: 'Connection successful! {0} tool(s) available.',
    mcp_test_failed: 'Connection failed: {0}',
    mcp_reload: 'Reload MCP',
    mcp_reloading: 'Reloading MCP servers...',
    mcp_reload_success: 'MCP servers reloaded.',
    mcp_reload_failed: 'Failed to reload MCP servers.',
    // PDF preview (#480)
  ...
  untitled:'Untitled',
    ...
    workspace_tab_tasks: 'Tasks',
    workspace_tab_artifacts: 'Artifacts',
    workspace_tab_references: 'Refs',
    workspace_inspector_no_session: 'Open a conversation to inspect session files.',
    workspace_artifacts_empty: 'No artifacts detected yet. Files created or edited during this session will appear here.',
    workspace_references_empty: 'No referenced files yet. Files read or searched during this session will appear here.',
    workspace_ref_dir: 'directory',
    workspace_outside_workspace: 'outside workspace',
    workspace_file_missing: 'not found',
    workspace_preview_ready: 'preview',
    workspace_preview_unavailable: 'Preview unavailable for this path.',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_mcp_meta: 'Model Context Protocol server configuration.',
    ...
    tab_chat: 'Chat',
    tab_tasks: 'Tasks',
    tab_integration_workspace_files: 'Workspace files',
    integration_workspace_search_placeholder: 'Search filenames…',
    integration_workspace_type_filter: 'File extension filter',
    integration_workspace_type_all: 'All extensions',
    integration_workspace_sort_by: 'Sort by',
    integration_workspace_sort_path: 'Path',
    integration_workspace_sort_size: 'Size',
    integration_workspace_sort_mtime: 'Modified',
    integration_workspace_sort_ctime: 'Created',
    integration_workspace_sort_order: 'Sort order',
    integration_workspace_order_desc: 'Descending',
    integration_workspace_order_asc: 'Ascending',
    integration_ws_select_file: 'Select a file',
    integration_ws_select_file_sub: 'Choose a file from the list to preview it here.',
    tab_skills: 'Skills',
    tab_skillhub: 'SkillHub',
    search_skillhub: 'Search catalog...',
    skillhub_empty_title: 'Select a skill from the catalog',
    skillhub_empty_sub: 'Browse remote skills and install them to your active profile.',
    skillhub_install: 'Install',
    skillhub_uninstall: 'Uninstall',
    skillhub_scope_hub: 'Catalog',
    skillhub_scope_installed: 'Installed',
    skillhub_scope_not_installed: 'Not installed',
    skillhub_scope_custom: 'My skills',
    skillhub_category_all: 'All',
    skillhub_no_categories: 'No categories available',
    skillhub_custom_hint: 'Local custom skill. Use Edit to update SKILL.md or Delete to remove it.',
    skillhub_upload: 'Upload',
    skillhub_upload_browse: 'Browse files',
    skillhub_upload_drop_title: 'Drop skill file here',
    skillhub_upload_drop_hint: 'SKILL.md or .zip package',
    skillhub_upload_drop_active: 'Release to upload',
    skillhub_upload_invalid_type: 'Only .md and .zip files are supported',
    skillhub_upload_ok: 'Skill uploaded',
    skillhub_upload_failed: 'Upload failed',
    skillhub_download: 'Download',
    skillhub_download_failed: 'Download failed',
    tab_memory: 'Memory',
    ...
    profile_pin: 'Pin',
    profile_unpin: 'Unpin',
    profile_pin_limit: 'Up to 5 profiles can be pinned. Unpin one before pinning another.',
    ...
    cron_schedule_once_warning: "Duration forms like '30m' run once and remain in the task list after completion. Use 'every 30m' for a recurring job.",
    ...
    cron_profile_required: 'Profile is required.',
    cron_profile_required_placeholder: 'Select profile',
    integration_cron_all_profiles: 'All profiles',
    integration_cron_profile_required_hint: 'Cron Hub jobs are stored and run under this profile; server default is not available here.',
    integration_cron_skills_profile_hint: "Skills are loaded from the selected profile.",
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    cron_schedule_once_warning: 'Forme di durata come \'30m\' vengono eseguite una volta e restano nell\'elenco dopo il completamento. Usa \'every 30m\' per un job ricorrente.',
    cron_prompt_label: 'Prompt',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    cron_schedule_once_warning: "'30m' のような期間指定は 1 回だけ実行され、完了後もタスク一覧に残ります。繰り返すには 'every 30m' を使ってください。",
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    cron_schedule_once_warning: "Интервалы вроде '30m' выполняются один раз и остаются в списке после завершения. Используйте 'every 30m' для повторяющегося задания.",
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    cron_schedule_once_warning: "Las duraciones como '30m' se ejecutan una vez y permanecen en la lista tras completarse. Usa 'every 30m' para un trabajo recurrente.",
    cron_prompt_label: 'Prompt',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    cron_schedule_once_warning: "Dauerangaben wie '30m' laufen einmal und bleiben nach Abschluss in der Aufgabenliste. Verwende 'every 30m' für eine wiederkehrende Aufgabe.",
    cron_prompt_label: 'Prompt',
  ...
  zh: {
    ...
    mcp_field_env: '环境变量',
    mcp_manage_hint: '使用添加/编辑/删除管理服务器，然后点击重新加载 MCP 使更改生效。',
    mcp_test_connection: '测试连接',
    mcp_testing: '正在测试连接...',
    mcp_test_success: '连接成功！{0} 个工具可用。',
    mcp_test_failed: '连接失败：{0}',
    mcp_reload: '重新加载 MCP',
    mcp_reloading: '正在重新加载 MCP 服务器...',
    mcp_reload_success: 'MCP 服务器已重新加载。',
    mcp_reload_failed: 'MCP 服务器重新加载失败。',
    thinking: '思考过程',
    expand_all: '全部展开',
    collapse_all: '全部折叠',
    edit_failed: '编辑失败：',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    tab_skills: '技能',
    tab_skillhub: '技能商店',
    search_skillhub: '搜索技能目录...',
    skillhub_empty_title: '从目录中选择技能',
    skillhub_empty_sub: '浏览远程技能并安装到当前配置文件。',
    skillhub_install: '安装',
    skillhub_uninstall: '卸载',
    skillhub_scope_hub: '技能市场',
    skillhub_scope_installed: '已安装',
    skillhub_scope_not_installed: '未安装',
    skillhub_scope_custom: '我的创建',
    skillhub_category_all: '全部',
    skillhub_no_categories: '暂无分类',
    skillhub_custom_hint: '本地自建技能，可编辑 SKILL.md 或点击删除按钮移除。',
    skillhub_upload: '上传',
    skillhub_upload_browse: '选择文件',
    skillhub_upload_drop_title: '将技能文件拖到此处',
    skillhub_upload_drop_hint: '支持 SKILL.md 或 .zip 压缩包',
    skillhub_upload_drop_active: '松开即可上传',
    skillhub_upload_invalid_type: '仅支持 .md 与 .zip 文件',
    skillhub_upload_ok: '技能已上传',
    skillhub_upload_failed: '上传失败',
    skillhub_download: '下载',
    skillhub_download_failed: '下载失败',
    tab_tasks: '任务',
    tab_kanban: '看板',
    kanban_board: '看板',
    ...
    tab_workspaces: '工作区',
    tab_integration_workspace_files: 'Workspace 文件',
    integration_workspace_search_placeholder: '搜索文件名…',
    integration_workspace_type_filter: '文件后缀过滤',
    integration_workspace_type_all: '全部后缀',
    integration_workspace_sort_by: '排序字段',
    integration_workspace_sort_path: '路径',
    integration_workspace_sort_size: '大小',
    integration_workspace_sort_mtime: '修改时间',
    integration_workspace_sort_ctime: '创建时间',
    integration_workspace_sort_order: '排序方向',
    integration_workspace_order_desc: '降序',
    integration_workspace_order_asc: '升序',
    integration_ws_select_file: '选择文件',
    integration_ws_select_file_sub: '从左侧列表选择文件，在此预览。',
    tab_profiles: '配置',
    tab_logs: '日志',
    tab_settings: '设置',
    ...
    profile_pin: '置顶',
    profile_unpin: '取消置顶',
    profile_pin_limit: '最多可置顶 5 个配置档，请先取消其他置顶。',
    ...
    cron_schedule_once_warning: "像 '30m' 这样的时长写法只会运行一次，完成后会保留在任务列表中。要循环执行，请使用 'every 30m'。",
    ...
    cron_profile_required: '必须选择配置档。',
    cron_profile_required_placeholder: '选择配置档',
    integration_cron_all_profiles: '所有配置档',
    integration_cron_profile_required_hint: 'Cron Hub 任务会存储并运行在所选配置档下，不能使用服务器默认。',
    integration_cron_skills_profile_hint: '技能来自所选配置档。',
    ...
    settings_tab_mcp: 'MCP',
    settings_section_mcp_meta: 'Model Context Protocol 服务器配置。',
    settings_tab_help: 'Help',
    settings_help_meta: 'Resources and support for Hermes WebUI.',
    settings_help_docs_label: 'Documentation',
    settings_help_docs_desc: 'Guides, configuration reference, and the full Hermes WebUI README.',
  ...
  'zh-Hant': {
    ...
    cron_schedule_once_warning: '像「30m」這樣的時長寫法只會執行一次，完成後會保留在任務列表中。要循環執行，請使用「every 30m」。',
  ...
  pt: {
    ...
    cron_schedule_once_warning: "Durações como '30m' rodam uma vez e permanecem na lista após a conclusão. Use 'every 30m' para uma tarefa recorrente.",
    cron_prompt_label: 'Prompt',
  ...
  fr: {
    ...
    cron_schedule_once_warning: 'Les formulaires de durée tels que « 30 m » s\'exécutent une fois et restent dans la liste après achèvement. Utilisez « every 30m » pour une tâche récurrente.',
  ...
  pl: {
    ...
    cron_schedule_once_warning: 'Formy czasu trwania, takie jak \'30m\', są uruchamiane raz i pozostają na liście po zakończeniu. Użyj \'every 30m\' dla zadania cyklicznego.',
