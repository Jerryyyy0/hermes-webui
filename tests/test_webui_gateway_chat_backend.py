...
def test_gateway_chat_health_payload_is_documented_as_operator_diagnostic_only():
    ...
    # docs/guides/advanced-chat-setup.md during the v0.51.192 README IA pass (it's a
    ...
    advanced = Path("docs/guides/advanced-chat-setup.md").read_text(encoding="utf-8")
