...
If you want WSL2 systemd integration instead, see `docs/operations/supervisor.md` for foreground process-supervisor guidance and adapt the Linux `systemd --user` pattern to your distro.
